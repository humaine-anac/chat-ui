...
const {interpretMessage, extractBidFromMessage} = require(path.join(__dirname, '/extract-bid.js'));
const {classifyMessage} = require(path.join(__dirname, '/conversation.js'));
